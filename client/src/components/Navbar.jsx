...
const Navbar = () => {
  ...
  const logout = () => {
    ...
    setToken("");
    setCartItems({});
    // BUG: navigate("/login") is missing, user state might not sync properly
  };
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      <Link to="/">
        <img src={assets.urban_logo} className="w-48" alt="Logo" />
      </Link>
      <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
        ...
        <NavLink
          to="/sale"
          className="flex flex-col item-center gap-1 text-red-600"
        >
          <p>SALE</p>
